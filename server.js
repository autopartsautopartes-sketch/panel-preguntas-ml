...
route('GET', '/api/cotizador', async (req, res) => {
  ...
  // Stock FÍSICO propio por sucursal (Buenos Aires / Rufino) — lo ven todos los usuarios.
  out.sucursales = _cotStockSucursales(cod);
